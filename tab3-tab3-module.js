...
/* harmony import */ var _tab3_page__WEBPACK_IMPORTED_MODULE_234__ = __webpack_require__(/*! ./tab3.page */ "./src/app/tab3/tab3.page.ts");
...
var routes = [
    ...
    {
        path: '',
        component: _tab3_page__WEBPACK_IMPORTED_MODULE_234__["Tab3Page"]
    },
    {
        path: 'nav1',
...
var Tab3PageModule = /** @class */ (function () {
    ...
    Tab3PageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            ...
            declarations: [
                _tab3_page__WEBPACK_IMPORTED_MODULE_234__["Tab3Page"],
            ],
            entryComponents: [
...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(http, route, router, appGlobalService, modalController, mapBaiduService, tabsService, eventService, actionSheet, // 必须有
    alertController) {
        var _this = this;
        this.http = http;
        this.route = route;
        ...
        this.eventService.eventEmit.on("tab3", function (obj) {
    ...
    Tab3Page.prototype.getViewData = function (isFirst) {
        var _this = this;
        this.route.queryParams.subscribe(function (p) {
            if (localStorage.getItem("appNav")) {
                var appNav = JSON.parse(localStorage.getItem("appNav"))[2];
    ...
    Tab3Page.prototype.netWork = function () {
        var _this = this;
        ...
        this.http.post("application/part/", this.viewParams, function (res) {
            ...
            if (res) {
                ...
                if (_this.appGlobalService.clientType === "pxw") {
                    try {
                        if (parseScript.tags[2].style === "invitationMessageTag") {
                            var pxwTabObj = _this.getPxwTabObj();
                ...
                if (parseScript.code === 501) {
                    ...
                    _this.tabsService.getPageData(res, function (pageData) {
                        ...
                        if (_this.coms[0] &&
                            ...
                            _this.coms[0].tagData.name === "imagesTag") {
    ...
    Tab3Page.prototype.buttonClick = function (obj) {
        if (obj.type === "page") {
            var params = {
                pageId: obj.target,
                params: {},
    ...
    Tab3Page.prototype.showCityModel = function (target) {
    ...
    Tab3Page.prototype.searchButtonClick = function (obj) {
     ...
     * 返回方法
     */
    Tab3Page.prototype.back = function () {
        window.history.back();
    };
    Tab3Page.prototype.close = function () {
        window.history.back();
    };
    /** 收藏 */
    Tab3Page.prototype.favorite = function (submit) {
        var _this = this;
        // 判断是否登录 登录 返回 详情
        var params = {
            id: submit.id,
    ...
    // 分享弹框
    Tab3Page.prototype.presentModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal, modalData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    /** 分享 */
    Tab3Page.prototype.share = function (link) {
        var _this = this;
    ...
    Tab3Page.prototype.subChange = function (obj, indexTab) {
        var _this = this;
            ...
            this.http.post("application/part", {
                ...
                if (res !== undefined && res != null) {
                    setTimeout(function () {
                        ...
                        _this.eventService.eventEmit.emit("refreshTab3FixedContainer", "refreshTab3FixedContainer");
                    }, 50);
                }
            });
        }
    ...
    // 聊天
    Tab3Page.prototype.chat = function (chat) {
        var _this = this;
        if (chat.link && chat.link.type === "chat") {
            ...
            if (ifLogin) {
                this.http.getImId(chat.link.params.opportunity_id, chat.link.params.customer_id, cityId, function (item) {
                    _this.router.navigate(["home/tab3/chatOnline"], {
    ...
    // 更多
    Tab3Page.prototype.moreLine = function (more) {
        var that = this;
        var buttons = [];
    ...
    Tab3Page.prototype.selectItem = function (item) {
        var _this = this;
    ...
    // ranking-modal
    Tab3Page.prototype.openRankingModal = function (className, item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var params;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    // alert
    Tab3Page.prototype.question = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Tab3Page.prototype.inputAlert = function (item) {
        var _this = this;
        var that = this;
    ...
    //
    Tab3Page.prototype.filter = function (filter) {
        var param = {
    ...
    // 确定提交表单用 暂时没用
    Tab3Page.prototype.textButton = function (textButton) {
        console.log(textButton);
    };
    // 数组btn
    Tab3Page.prototype.iconButtonClick = function (item) {
        this.selectItem(item);
    };
    Tab3Page.prototype.toggle = function (toggleButton, index) {
    ...
    Tab3Page.prototype.getCurrentToggleData = function () {
        var _this = this;
    ...
    Tab3Page.prototype.toggleChange = function (obj, index) {
        var _this = this;
        if (obj !== undefined && obj.partLink !== undefined) {
            this.http.post("application/part", {
                viewId: obj.partLink.target,
    ...
    Tab3Page.prototype.onScroll = function (e) {
        e.preventDefault();
    };
    // 点击遮罩层关闭下拉面板
    Tab3Page.prototype.backdropclick = function () {
        this.openBackdrop = false;
    };
    // 刷新当前页
    Tab3Page.prototype.refreshPage = function () {
        this.netWork();
    };
    Tab3Page.prototype.segmentChanged = function (e) {
    ...
    Tab3Page.prototype.customSegmentChanged = function (e) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Tab3Page.prototype.getPxwTabObj = function () {
        return {
            type: "tag",
    ...
    Tab3Page.prototype.refreshData = function (event) {
    ...
    ], Tab3Page.prototype, "scrollContent", void 0);
